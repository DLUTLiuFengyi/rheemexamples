package com.github.sekrus.wordcount.java;
...
public class WordCount {
    ...
    public static void main(String [] args) {
        ...
        //Plugin[] plugins = parsePlugins("java");
        //String inputUrl = "file:/D:/rheem/tmp.txt"; //适用于windows
        //String inputUrl = "file:/home/lfy/data/tmp.txt"; //适用于linux

        //打包成jar包之后，window中命令：java -jar xxx.jar "java" "file:\D:\rheem\tmp.txt"
